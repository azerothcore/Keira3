...
SAI_EVENT_COMMENTS[SAI_EVENTS.ESCORT_START] = `On Path _waypointParamTwo_ Started`;
SAI_EVENT_COMMENTS[SAI_EVENTS.ESCORT_REACHED] = `On Point _waypointParamOne_ of Path _waypointParamTwo_ Reached`;
...
SAI_EVENT_COMMENTS[SAI_EVENTS.ESCORT_PAUSED] = `On Path _eventParamTwo_ Paused`;
SAI_EVENT_COMMENTS[SAI_EVENTS.ESCORT_RESUMED] = `On Path _eventParamTwo_ Resumed`;
SAI_EVENT_COMMENTS[SAI_EVENTS.ESCORT_STOPPED] = `On Path _eventParamTwo_ Stopped`;
SAI_EVENT_COMMENTS[SAI_EVENTS.ESCORT_ENDED] = `On Path _eventParamTwo_ Finished`;
...
SAI_ACTION_COMMENTS[SAI_ACTIONS.ESCORT_START] = `Start _waypointStartActionParamThree_Path _actionParamTwo_`;
SAI_ACTION_COMMENTS[SAI_ACTIONS.ESCORT_PAUSE] = `Pause Waypoint`;
SAI_ACTION_COMMENTS[SAI_ACTIONS.ESCORT_STOP] = `Stop Waypoint`;
...
SAI_ACTION_COMMENTS[SAI_ACTIONS.ESCORT_RESUME] = `Resume Waypoint`;
...
SAI_ACTION_COMMENTS[SAI_ACTIONS.DISMOUNT] = `Dismount`;
...
SAI_ACTION_COMMENTS[SAI_ACTIONS.WAYPOINT_START] = `Start Path _actionParamOne_`;
...
SAI_ACTION_COMMENTS[SAI_ACTIONS.SUMMON_GAMEOBJECT_GROUP] = `Summon Gameobject Group _actionParamOne_`;
