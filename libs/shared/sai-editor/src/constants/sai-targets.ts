...
SAI_TARGET_PARAM1_NAMES[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = 'Max Range';
SAI_TARGET_PARAM2_NAMES[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = 'Player Only';
SAI_TARGET_PARAM3_NAMES[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = 'Power Type';
SAI_TARGET_PARAM4_NAMES[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = 'Aura';
SAI_TARGET_PARAM1_TOOLTIPS[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = '0: unlimited';
SAI_TARGET_PARAM2_TOOLTIPS[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = '(0/1)';
SAI_TARGET_PARAM3_TOOLTIPS[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = `Power Types:
1 - MANA;
2 - RAGE;
3 - FOCUS;
4 - ENERGY;`;
SAI_TARGET_PARAM4_TOOLTIPS[SAI_TARGETS.HOSTILE_SECOND_AGGRO] = 'only target units without this aura';
...
SAI_TARGET_PARAM1_NAMES[SAI_TARGETS.HOSTILE_LAST_AGGRO] = 'Max Range';
SAI_TARGET_PARAM2_NAMES[SAI_TARGETS.HOSTILE_LAST_AGGRO] = 'Player Only';
SAI_TARGET_PARAM3_NAMES[SAI_TARGETS.HOSTILE_LAST_AGGRO] = 'Power Type';
SAI_TARGET_PARAM4_NAMES[SAI_TARGETS.HOSTILE_LAST_AGGRO] = 'Aura';
SAI_TARGET_PARAM1_TOOLTIPS[SAI_TARGETS.HOSTILE_LAST_AGGRO] = '0: unlimited';
SAI_TARGET_PARAM2_TOOLTIPS[SAI_TARGETS.HOSTILE_LAST_AGGRO] = '(0/1)';
SAI_TARGET_PARAM3_TOOLTIPS[SAI_TARGETS.HOSTILE_LAST_AGGRO] = `Power Types:
1 - MANA;
2 - RAGE;
3 - FOCUS;
4 - ENERGY;`;
SAI_TARGET_PARAM4_TOOLTIPS[SAI_TARGETS.HOSTILE_LAST_AGGRO] = 'only target units without this aura';
...
SAI_TARGET_PARAM1_NAMES[SAI_TARGETS.HOSTILE_RANDOM] = 'Max Range';
SAI_TARGET_PARAM2_NAMES[SAI_TARGETS.HOSTILE_RANDOM] = 'Player Only';
SAI_TARGET_PARAM3_NAMES[SAI_TARGETS.HOSTILE_RANDOM] = 'Power Type';
SAI_TARGET_PARAM4_NAMES[SAI_TARGETS.HOSTILE_RANDOM] = 'Aura';
SAI_TARGET_PARAM1_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM] = '0: unlimited';
SAI_TARGET_PARAM2_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM] = '(0/1)';
SAI_TARGET_PARAM3_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM] = `Power Types:
1 - MANA;
2 - RAGE;
3 - FOCUS;
4 - ENERGY;`;
...
SAI_TARGET_PARAM4_NAMES[SAI_TARGETS.HOSTILE_RANDOM_NOT_TOP] = 'Aura';
SAI_TARGET_PARAM1_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM_NOT_TOP] = '0: unlimited';
SAI_TARGET_PARAM2_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM_NOT_TOP] = '(0/1)';
SAI_TARGET_PARAM3_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM_NOT_TOP] = `Power Types:
1 - MANA;
2 - RAGE;
3 - FOCUS;
4 - ENERGY;`;
SAI_TARGET_PARAM4_TOOLTIPS[SAI_TARGETS.HOSTILE_RANDOM_NOT_TOP] = 'only target units without this aura';
...
SAI_TARGET_TOOLTIPS[SAI_TARGETS.RANDOM_POINT] =
...
SAI_TARGET_PARAM1_TOOLTIPS[SAI_TARGETS.FORMATION] = '0: members only (no leader), 1: leader only, 2: all';
SAI_TARGET_PARAM2_TOOLTIPS[SAI_TARGETS.FORMATION] = '0: any entry, or specific creature_template.entry to filter';
SAI_TARGET_PARAM3_TOOLTIPS[SAI_TARGETS.FORMATION] = '(0/1) exclude the scripting creature from results';
