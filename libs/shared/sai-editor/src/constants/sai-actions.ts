...
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'PathId 1';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'PathId 2';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Run';
SAI_ACTION_PARAM4_NAMES[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Repeat';
SAI_ACTION_PARAM3_TOOLTIPS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = BOOLEAN_VALUE_TOOLTIP;
SAI_ACTION_PARAM4_TOOLTIPS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = BOOLEAN_VALUE_TOOLTIP;
