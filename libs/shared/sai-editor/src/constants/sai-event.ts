...
SAI_EVENT_TOOLTIPS[SAI_EVENTS.WAYPOINT_DATA_REACHED] = 'On Creature Waypoint Reached. Uses `waypoint_data` table';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.WAYPOINT_DATA_REACHED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.WAYPOINT_DATA_REACHED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.WAYPOINT_DATA_REACHED] = '0: any';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.WAYPOINT_DATA_REACHED] = '0: any';

// SMART_EVENT_WAYPOINT_DATA_ENDED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.WAYPOINT_DATA_ENDED] = 'On Creature Waypoint Finished. Uses `waypoint_data` table';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.WAYPOINT_DATA_ENDED] = 'PointId';
