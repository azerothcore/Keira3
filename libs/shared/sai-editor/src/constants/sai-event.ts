...
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.RANGE] = 'InitialMin';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.RANGE] = 'InitialMax';
SAI_EVENT_PARAM3_NAMES[SAI_EVENTS.RANGE] = 'RepeatMin';
SAI_EVENT_PARAM4_NAMES[SAI_EVENTS.RANGE] = 'RepeatMax';
SAI_EVENT_PARAM5_NAMES[SAI_EVENTS.RANGE] = 'RangeMin';
SAI_EVENT_PARAM6_NAMES[SAI_EVENTS.RANGE] = 'RangeMax';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.RANGE] = 'ms';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.RANGE] = 'ms';
SAI_EVENT_PARAM3_TOOLTIPS[SAI_EVENTS.RANGE] = 'ms';
SAI_EVENT_PARAM4_TOOLTIPS[SAI_EVENTS.RANGE] = 'ms';
SAI_EVENT_PARAM5_TOOLTIPS[SAI_EVENTS.RANGE] = 'yards';
SAI_EVENT_PARAM6_TOOLTIPS[SAI_EVENTS.RANGE] = 'yards';
...
SAI_EVENT_PARAM3_NAMES[SAI_EVENTS.MOVEMENTINFORM] = 'PathId';
...
SAI_EVENT_PARAM3_TOOLTIPS[SAI_EVENTS.MOVEMENTINFORM] = '0 - any';
...
SAI_EVENT_TOOLTIPS[SAI_EVENTS.ESCORT_START] = 'On waypoint started';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.ESCORT_START] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.ESCORT_START] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.ESCORT_START] = 'Use 0 for ANY point';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.ESCORT_START] = 'Use 0 for ANY path';

// SMART_EVENT_ESCORT_REACHED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.ESCORT_REACHED] = 'On waypoint reached';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.ESCORT_REACHED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.ESCORT_REACHED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.ESCORT_REACHED] = 'Use 0 for ANY point';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.ESCORT_REACHED] = 'Use 0 for ANY path';
...
SAI_EVENT_TOOLTIPS[SAI_EVENTS.ESCORT_PAUSED] = 'On Creature Paused at Waypoint ID';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.ESCORT_PAUSED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.ESCORT_PAUSED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.ESCORT_PAUSED] = 'Use 0 for ANY point';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.ESCORT_PAUSED] = 'Use 0 for ANY path';

// SMART_EVENT_ESCORT_RESUMED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.ESCORT_RESUMED] = 'On Creature Resumed after Waypoint ID';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.ESCORT_RESUMED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.ESCORT_RESUMED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.ESCORT_RESUMED] = 'Use 0 for ANY point';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.ESCORT_RESUMED] = 'Use 0 for ANY path';

// SMART_EVENT_ESCORT_STOPPED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.ESCORT_STOPPED] = 'On Creature Stopped On Waypoint ID';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.ESCORT_STOPPED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.ESCORT_STOPPED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.ESCORT_STOPPED] = 'Use 0 for ANY point';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.ESCORT_STOPPED] = 'Use 0 for ANY path';

// SMART_EVENT_ESCORT_ENDED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.ESCORT_ENDED] = 'On Creature Waypoint Path Ended';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.ESCORT_ENDED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.ESCORT_ENDED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.ESCORT_ENDED] = 'Use 0 for ANY point';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.ESCORT_ENDED] = 'Use 0 for ANY path';
...
SAI_EVENT_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'On behind current victim';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.IS_BEHIND_TARGET] = 'InitialMin';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.IS_BEHIND_TARGET] = 'InitialMax';
SAI_EVENT_PARAM3_NAMES[SAI_EVENTS.IS_BEHIND_TARGET] = 'RepeatMin';
SAI_EVENT_PARAM4_NAMES[SAI_EVENTS.IS_BEHIND_TARGET] = 'RepeatMax';
SAI_EVENT_PARAM5_NAMES[SAI_EVENTS.IS_BEHIND_TARGET] = 'RangeMin';
SAI_EVENT_PARAM6_NAMES[SAI_EVENTS.IS_BEHIND_TARGET] = 'RangeMax';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'ms';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'ms';
SAI_EVENT_PARAM3_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'ms';
SAI_EVENT_PARAM4_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'ms';
SAI_EVENT_PARAM5_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'yards';
SAI_EVENT_PARAM6_TOOLTIPS[SAI_EVENTS.IS_BEHIND_TARGET] = 'yards';
...
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'InitialMin';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'InitialMax';
...
SAI_EVENT_PARAM5_NAMES[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'HP%';
SAI_EVENT_PARAM6_NAMES[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'Range';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'ms';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'ms';
SAI_EVENT_PARAM3_TOOLTIPS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'ms';
SAI_EVENT_PARAM4_TOOLTIPS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'ms';
SAI_EVENT_PARAM5_TOOLTIPS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'HP Percentage required to fire event';
SAI_EVENT_PARAM6_TOOLTIPS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'yards';
...
SAI_EVENT_PARAM5_NAMES[SAI_EVENTS.AREA_CASTING] = 'RangeMin';
SAI_EVENT_PARAM6_NAMES[SAI_EVENTS.AREA_CASTING] = 'RangeMax';
...
SAI_EVENT_PARAM5_TOOLTIPS[SAI_EVENTS.AREA_CASTING] = 'yards';
SAI_EVENT_PARAM6_TOOLTIPS[SAI_EVENTS.AREA_CASTING] = 'yards';
...
SAI_EVENT_PARAM5_NAMES[SAI_EVENTS.AREA_RANGE] = 'RangeMin';
SAI_EVENT_PARAM6_NAMES[SAI_EVENTS.AREA_RANGE] = 'RangeMax';
...
SAI_EVENT_PARAM6_TOOLTIPS[SAI_EVENTS.AREA_RANGE] = 'yards';

// SMART_EVENT_SUMMONED_UNIT_EVADE
SAI_EVENT_TOOLTIPS[SAI_EVENTS.SUMMONED_UNIT_EVADE] = 'When specified summoned creature (or 0, for all) evade.';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.SUMMONED_UNIT_EVADE] = 'CreatureId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.SUMMONED_UNIT_EVADE] = 'CooldownMin';
SAI_EVENT_PARAM3_NAMES[SAI_EVENTS.SUMMONED_UNIT_EVADE] = 'CooldownMax';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.SUMMONED_UNIT_EVADE] = '0 for all';

// SMART_EVENT_WAYPOINT_REACHED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.WAYPOINT_REACHED] = 'On Creature Waypoint Reached. Uses `waypoint_data` table';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.WAYPOINT_REACHED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.WAYPOINT_REACHED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.WAYPOINT_REACHED] = '0: any';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.WAYPOINT_REACHED] = '0: any';

// SMART_EVENT_WAYPOINT_ENDED
SAI_EVENT_TOOLTIPS[SAI_EVENTS.WAYPOINT_ENDED] = 'On Creature Waypoint Finished. Uses `waypoint_data` table';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.WAYPOINT_ENDED] = 'PointId';
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.WAYPOINT_ENDED] = 'PathId';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.WAYPOINT_ENDED] = 'unused';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.WAYPOINT_ENDED] = '0: any';
