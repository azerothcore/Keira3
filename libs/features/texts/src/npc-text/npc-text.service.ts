...
import { NPC_TEXT_ID, NPC_TEXT_NAME, NPC_TEXT_TABLE, NpcText } from '@keira/shared/acore-world-model';
...
export class NpcTextService extends SingleRowEditorService<NpcText> {
  ...
  constructor(protected override handlerService: NpcTextHandlerService) {
    super(NpcText, NPC_TEXT_TABLE, NPC_TEXT_ID, NPC_TEXT_NAME, true, handlerService);
  }
}
