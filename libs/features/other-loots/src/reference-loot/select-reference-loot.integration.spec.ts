...
describe('SelectReferenceLoot integration tests', () => {
  ...
  // SelectReferenceLootService.fieldList is [LOOT_TEMPLATE_ID] only and entityNameField is null — there is no
  ...
  it('searching and selecting an existing entity from the datatable should correctly work', () => {
    ...
    expect(selectSpy).toHaveBeenCalledWith(false, `${results[0].Entry}`, 'reference_loot_template');
