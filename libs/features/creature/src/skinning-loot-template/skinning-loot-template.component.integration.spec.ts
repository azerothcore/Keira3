...
describe('SkinningLootTemplate integration tests', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [ToastrModule.forRoot(), ModalModule.forRoot(), SkinningLootTemplateComponent, RouterTestingModule, TranslateTestingModule],
      providers: [
  ...
  describe('Creating new', () => {
    ...
    it('adding a row changing its values and duplicate it should correctly update the queries', () => {
      ...
      page.expectDiffQueryToContain(
        'DELETE FROM `skinning_loot_template` WHERE (`Entry` = 1234) AND (`Item` IN (123, 0));\n' +
          'INSERT INTO `skinning_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, ' +
          '`GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES\n' +
          "(1234, 123, 0, 1, 2, 1, 0, 1, 1, ''),\n" +
          "(1234, 0, 0, 1, 2, 1, 0, 1, 1, '');",
