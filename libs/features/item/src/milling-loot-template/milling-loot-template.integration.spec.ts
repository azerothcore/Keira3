...
describe('MillingLootTemplate integration tests', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ToastrModule.forRoot(), ModalModule.forRoot(), MillingLootTemplateComponent, RouterTestingModule, TranslateTestingModule],
      providers: [
  ...
  function setup(creatingNew: boolean) {
    ...
    const fixture = TestBed.createComponent(MillingLootTemplateComponent);
    const page = new MillingLootTemplatePage(fixture);
  ...
  describe('Creating new', () => {
    ...
    it('adding a row changing its values and duplicate it should correctly update the queries', () => {
      ...
      page.expectDiffQueryToContain(
        'DELETE FROM `milling_loot_template` WHERE (`Entry` = 1234) AND (`Item` IN (123, 0));\n' +
          'INSERT INTO `milling_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, ' +
          '`GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES\n' +
          "(1234, 123, 0, 1, 2, 1, 0, 1, 1, ''),\n" +
          "(1234, 0, 0, 1, 2, 1, 0, 1, 1, '');",
  ...
  describe('Editing existing', () => {
    ...
    it('schema sweep: every editable field flows into the diff query', async () => {
      ...
      const written = await page.changeAllFieldsAsync(new MillingLootTemplate(), ['Entry', 'Item']);
