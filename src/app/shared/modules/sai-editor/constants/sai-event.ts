...
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.NEAR_PLAYERS] = 'Radius';
SAI_EVENT_PARAM3_NAMES[SAI_EVENTS.NEAR_PLAYERS] = 'FirstCheck';
SAI_EVENT_PARAM4_NAMES[SAI_EVENTS.NEAR_PLAYERS] = 'RepeatTimer';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS] = 'How many players are needed for the event to trigger.';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS] = 'Radius in yards to check for players.';
SAI_EVENT_PARAM3_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS] = 'First check for players in milliseconds (ms).';
SAI_EVENT_PARAM4_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS] = 'Repeating check for players ever X milliseconds (ms).';
...
SAI_EVENT_PARAM2_NAMES[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'Radius';
SAI_EVENT_PARAM3_NAMES[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'FirstCheck';
SAI_EVENT_PARAM4_NAMES[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'RepeatTimer';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'Maximum amount of players for the event to trigger.';
SAI_EVENT_PARAM2_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'Radius in yards to check for players.';
SAI_EVENT_PARAM3_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'First check for players in milliseconds (ms).';
SAI_EVENT_PARAM4_TOOLTIPS[SAI_EVENTS.NEAR_PLAYERS_NEGATION] = 'Repeating check for players ever X milliseconds (ms).';
