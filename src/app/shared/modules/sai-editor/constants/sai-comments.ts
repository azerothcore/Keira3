...
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_REACHED] = `On any Waypoint Reached`;
...
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_START] = `On any Waypoint Started`;
...
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_PAUSED] = `On any Waypoint Paused`;
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_RESUMED] = `On any Waypoint Resumed`;
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_STOPPED] = `On any Waypoint Stopped`;
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_ENDED] = `On any Waypoint Finished`;
