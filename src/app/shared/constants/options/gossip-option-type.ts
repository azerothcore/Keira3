...
export const OPTION_TYPE: Option[] = [
  ...
  { value: 3,  name: 'VENDOR - UNIT_NPC_FLAG_VENDOR (Make sure there is npc_vendor data for this creature) (npcflag=128)' },
  { value: 4,  name: 'TAXIVENDOR - UNIT_NPC_FLAG_TAXIVENDOR (npcflag=8192)' },
  { value: 5,  name: 'TRAINE - UNIT_NPC_FLAG_TRAINER (Remember to set trainer_class in creature_template) (npcflag=16)' },
