...
describe('SelectGameobject integration tests', () => {
  ...
  //       'SELECT * FROM `gameobject_template` WHERE (`entry` LIKE \'%1200%\') AND (`name` LIKE \'%The People\\\'s Militia%\') LIMIT 100'
  //   },
  //   {
  //     testId: 2, id: '', name: `The People's Militia`, limit: '100', expectedQuery:
  //       'SELECT * FROM `gameobject_template` WHERE (`name` LIKE \'%The People\\\'s Militia%\') LIMIT 100'
  //   },
  //   {
