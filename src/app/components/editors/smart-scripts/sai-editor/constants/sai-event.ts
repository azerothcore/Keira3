...
export const SAI_EVENT_PARAM1_TEXTS = [];
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.UPDATE_IC] = 'InitialMin';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.UPDATE_OOC] = 'InitialMin';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.HEALTH_PCT] = 'Min health pct';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.MANA_PCT] = 'Min mana pct';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.KILL] = 'Cooldown min';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.SPELLHIT] = 'Spell id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.RANGE] = 'Min distance to target';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.OOC_LOS] = 'Ignore hostile targets (0/1)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.RESPAWN] = 'Respawn condition';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.TARGET_HEALTH_PCT] = 'Health pct min';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.VICTIM_CASTING] = 'RepeatMin';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH] = 'Health deficit (flat)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.FRIENDLY_IS_CC] = 'Radius';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.FRIENDLY_MISSING_BUFF] = 'Spellid';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.SUMMONED_UNIT] = 'Creature id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.TARGET_MANA_PCT] = 'Mana pct min';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.ACCEPTED_QUEST] = 'Quest id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.REWARD_QUEST] = 'Quest id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.RECEIVE_EMOTE] = 'Emote id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.HAS_AURA] = 'Spell id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.TARGET_BUFFED] = 'Spell id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.IC_LOS] = 'Ignore hostile targets (0/1)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.SPELLHIT_TARGET] = 'Spell id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.DAMAGED] = 'Minimum damage';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.DAMAGED_TARGET] = 'Minimum damage';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.MOVEMENTINFORM] = 'Movement type (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.SUMMON_DESPAWNED] = 'Creature entry (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.DATA_SET] = 'Field';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.WAYPOINT_START] = 'Point id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.WAYPOINT_REACHED] = 'Point id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.AREATRIGGER_ONTRIGGER] = 'Areatrigger id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.TEXT_OVER] = 'Group id (creature_text)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.RECEIVE_HEAL] = 'Minimum heal';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.WAYPOINT_PAUSED] = 'Point id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.WAYPOINT_RESUMED] = 'Point id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.WAYPOINT_STOPPED] = 'Point id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.WAYPOINT_ENDED] = 'Point id (0 any)';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.TIMED_EVENT_TRIGGERED] = 'Event id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.UPDATE] = 'InitialMin';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.GOSSIP_SELECT] = 'Gossip menu id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.IS_BEHIND_TARGET] = 'CooldownMin';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.GAME_EVENT_START] = 'Game event entry';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.GAME_EVENT_END] = 'Game event entry';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.GO_STATE_CHANGED] = 'Gameobject state';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.GO_EVENT_INFORM] = 'Event id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.ACTION_DONE] = 'Action id';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'Health pct min';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.DISTANCE_CREATURE] = 'Guid';
SAI_EVENT_PARAM1_TEXTS[SAI_EVENTS.DISTANCE_GAMEOBJECT] = 'Guid';
// TODO: add missing values

export const SAI_EVENT_PARAM2_TEXTS = [];
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.UPDATE_IC] = 'InitialMax';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.UPDATE_OOC] = 'InitialMax';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.HEALTH_PCT] = 'Max health pct';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.MANA_PCT] = 'Max mana pct';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.KILL] = 'Cooldown max';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.SPELLHIT] = 'Spell school (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.RANGE] = 'Max distance to target';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.OOC_LOS] = 'Max distance to target';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.RESPAWN] = 'Map id condition';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.TARGET_HEALTH_PCT] = 'Health pct max';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.VICTIM_CASTING] = 'RepeatMax';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH] = 'Radius';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.FRIENDLY_IS_CC] = 'RepeatMin';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.FRIENDLY_MISSING_BUFF] = 'Radius';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.SUMMONED_UNIT] = 'RepeatMin';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.TARGET_MANA_PCT] = 'Mana pct max';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.RECEIVE_EMOTE] = 'RepeatMin';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.HAS_AURA] = 'Stacks';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.TARGET_BUFFED] = 'Stacks';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.IC_LOS] = 'Max distance to target';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.SPELLHIT_TARGET] = 'Spell school';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.DAMAGED] = 'Maximum damage';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.DAMAGED_TARGET] = 'Maximum damage';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.MOVEMENTINFORM] = 'Point id';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.SUMMON_DESPAWNED] = 'CooldownMin';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.DATA_SET] = 'Value';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.WAYPOINT_START] = 'Path id (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.WAYPOINT_REACHED] = 'Path id (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.TEXT_OVER] = 'Creature entry (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.RECEIVE_HEAL] = 'Maximum heal';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.WAYPOINT_PAUSED] = 'Path id (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.WAYPOINT_RESUMED] = 'Path id (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.WAYPOINT_STOPPED] = 'Path id (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.WAYPOINT_ENDED] = 'Path id (0 any)';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.UPDATE] = 'InitialMax';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.GOSSIP_SELECT] = 'Gossip item id';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.IS_BEHIND_TARGET] = 'CooldownMax';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'Health pct max';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.DISTANCE_CREATURE] = 'Entry';
SAI_EVENT_PARAM2_TEXTS[SAI_EVENTS.DISTANCE_GAMEOBJECT] = 'Entry';
// TODO: add missing values

export const SAI_EVENT_PARAM3_TEXTS = [];
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.UPDATE_IC] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.UPDATE_OOC] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.HEALTH_PCT] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.MANA_PCT] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.KILL] = 'Player only (0/1)';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.SPELLHIT] = 'CooldownMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.RANGE] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.OOC_LOS] = 'Cooldown min';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.RESPAWN] = 'Zone id condition';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.TARGET_HEALTH_PCT] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.VICTIM_CASTING] = 'Spell id';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.FRIENDLY_IS_CC] = 'RepeatMax';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.FRIENDLY_MISSING_BUFF] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.SUMMONED_UNIT] = 'RepeatMax';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.TARGET_MANA_PCT] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.RECEIVE_EMOTE] = 'RepeatMax';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.HAS_AURA] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.TARGET_BUFFED] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.IC_LOS] = 'Cooldown min';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.SPELLHIT_TARGET] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.DAMAGED] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.DAMAGED_TARGET] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.SUMMON_DESPAWNED] = 'CooldownMax';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.DATA_SET] = 'CooldownMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.RECEIVE_HEAL] = 'CooldownMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.UPDATE] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'RepeatMin';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.DISTANCE_CREATURE] = 'Distance';
SAI_EVENT_PARAM3_TEXTS[SAI_EVENTS.DISTANCE_GAMEOBJECT] = 'Distance';
// TODO: add missing values

export const SAI_EVENT_PARAM4_TEXTS = [];
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.UPDATE_IC] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.UPDATE_OOC] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.HEALTH_PCT] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.MANA_PCT] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.KILL] = 'Entry (if param3 is 0)';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.SPELLHIT] = 'CooldownMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.RANGE] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.OOC_LOS] = 'Cooldown max';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.TARGET_HEALTH_PCT] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.FRIENDLY_MISSING_BUFF] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.TARGET_MANA_PCT] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.HAS_AURA] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.TARGET_BUFFED] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.IC_LOS] = 'Cooldown max';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.SPELLHIT_TARGET] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.DAMAGED] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.DAMAGED_TARGET] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.DATA_SET] = 'CooldownMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.RECEIVE_HEAL] = 'CooldownMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.UPDATE] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.FRIENDLY_HEALTH_PCT] = 'RepeatMax';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.DISTANCE_CREATURE] = 'RepeatTimer';
SAI_EVENT_PARAM4_TEXTS[SAI_EVENTS.DISTANCE_GAMEOBJECT] = 'RepeatTimer';
// TODO: add missing values
