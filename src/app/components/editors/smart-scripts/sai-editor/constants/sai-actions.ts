...
export const SAI_ACTION_PARAM1_TEXTS = [];
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.TALK] = 'GroupId';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_FACTION] = 'FactionId';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.MORPH_TO_ENTRY_OR_MODEL] = 'Creature entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SOUND] = 'Sound id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.PLAY_EMOTE] = 'Emote id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.FAIL_QUEST] = 'Quest id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.OFFER_QUEST] = 'Quest id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_REACT_STATE] = 'React state';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ACTIVATE_GOBJECT] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RANDOM_EMOTE] = 'Emote id 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CAST] = 'Spell ID';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SUMMON_CREATURE] = 'Creature entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.THREAT_SINGLE_PCT] = 'Threat increase in pct';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.THREAT_ALL_PCT] = 'Threat increase in pct';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_AREAEXPLOREDOREVENTHAPPENS] = 'Quest id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RESERVED_16] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_EMOTE_STATE] = 'Emote id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_UNIT_FLAG] = 'Unit flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_UNIT_FLAG] = 'Unit flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.AUTO_ATTACK] = 'Start or stop (0 / 1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ALLOW_COMBAT_MOVEMENT] = 'Allow or disallow (0 / 1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_EVENT_PHASE] = 'Phasemask';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.INC_EVENT_PHASE] = 'Increment';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.EVADE] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.FLEE_FOR_ASSIST] = 'Say flee text (0 / 1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_GROUPEVENTHAPPENS] = 'Quest id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.COMBAT_STOP] = 'Creature id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVEAURASFROMSPELL] = 'Spell id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.FOLLOW] = 'Distance';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RANDOM_PHASE] = 'Phasemask 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RANDOM_PHASE_RANGE] = 'Phasemask 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RESET_GOBJECT] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_KILLEDMONSTER] = 'Creature entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_INST_DATA] = 'Field';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_INST_DATA64] = 'Field';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.UPDATE_TEMPLATE] = 'Creature entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.DIE] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_IN_COMBAT_WITH_ZONE] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_FOR_HELP] = 'Radius';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_SHEATH] = 'Sheath state';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.FORCE_DESPAWN] = 'Time to despawn (ms)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_INVINCIBILITY_HP_LEVEL] = 'Flat value';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.MOUNT_TO_ENTRY_OR_MODEL] = 'Creature entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_INGAME_PHASE_MASK] = 'Phasemask';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_DATA] = 'Field';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.MOVE_FORWARD] = 'Distance in yards';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_VISIBILITY] = 'Visible (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_ACTIVE] = 'Active (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ATTACK_START] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SUMMON_GO] = 'Gameobject entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.KILL_UNIT] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ACTIVATE_TAXI] = 'Taxi id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.WP_START] = 'Walk/run (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.WP_PAUSE] = 'Time (ms)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.WP_STOP] = 'Despawn time (ms)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ADD_ITEM] = 'Item entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_ITEM] = 'Item entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.INSTALL_AI_TEMPLATE] = 'Template entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_RUN] = 'Off/on (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_FLY] = 'Off/on (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_SWIM] = 'Off/on (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.TELEPORT] = 'Map id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_COUNTER] = 'Variable id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.STORE_TARGET_LIST] = 'Variable id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.WP_RESUME] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_ORIENTATION] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CREATE_TIMED_EVENT] = 'Event id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.PLAYMOVIE] = 'Movie entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.MOVE_TO_POS] = 'Point id (0 any)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RESPAWN_TARGET] = 'Respawn time (seconds)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.EQUIP] = 'Equip template entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CLOSE_GOSSIP] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.TRIGGER_TIMED_EVENT] = 'Event id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_TIMED_EVENT] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ADD_AURA] = 'Spell id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.OVERRIDE_SCRIPT_BASE_OBJECT] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RESET_SCRIPT_BASE_OBJECT] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_SCRIPT_RESET] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_RANGED_MOVEMENT] = 'Attack distance';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_TIMED_ACTIONLIST] = 'Script entry';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_NPC_FLAG] = 'Npc flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ADD_NPC_FLAG] = 'Npc flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_NPC_FLAG] = 'Npc flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SIMPLE_TALK] = 'Groupid';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.INVOKER_CAST] = 'Spell ID';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CROSS_CAST] = 'Spell ID';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_RANDOM_TIMED_ACTIONLIST] = 'Script entry 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.CALL_RANDOM_RANGE_TIMED_ACTIONLIST] = 'Script entry 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.RANDOM_MOVE] = 'Maximum distance';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_UNIT_FIELD_BYTES_1] = 'Unit field bytes 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_UNIT_FIELD_BYTES_1] = 'Unit field bytes 1';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.INTERRUPT_SPELL] = 'With delay (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SEND_GO_CUSTOM_ANIM] = 'Animation (0-255)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_DYNAMIC_FLAG] = 'Dynamic flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ADD_DYNAMIC_FLAG] = 'Dynamic flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_DYNAMIC_FLAG] = 'Dynamic flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.JUMP_TO_POS] = 'Speed XY';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SEND_GOSSIP_MENU] = 'Gossip menu id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.GO_SET_LOOT_STATE] = 'Gameobject state';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SEND_TARGET_TO_TARGET] = 'Target id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_HOME_POS] = ''; // TODO
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_HEALTH_REGEN] = 'Off/on (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_ROOT] = 'Unroot/root (0/1)';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_GO_FLAG] = 'Gameobject flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ADD_GO_FLAG] = 'Gameobject flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_GO_FLAG] = 'Gameobject flags';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SUMMON_CREATURE_GROUP] = 'Summon group id';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.SET_POWER] = 'Power type';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.ADD_POWER] = 'Power type';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.REMOVE_POWER] = 'Power type';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.GAME_EVENT_STOP] = 'Id of the event';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.GAME_EVENT_START] = 'Id of the event';
SAI_ACTION_PARAM1_TEXTS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Waypoint 1';
// TODO: add missing values

export const SAI_ACTION_PARAM2_TEXTS = [];
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.TALK] = 'Duration';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.MORPH_TO_ENTRY_OR_MODEL] = 'Creature model';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SOUND] = 'Only to self (0/1)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.RANDOM_EMOTE] = 'Emote id 2';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CAST] = 'Cast Flags';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SUMMON_CREATURE] = 'Summon type';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.THREAT_SINGLE_PCT] = 'Threat decrease in pct';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.THREAT_ALL_PCT] = 'Threat decrease in pct';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_UNIT_FLAG] = 'Type (0 / 1)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.REMOVE_UNIT_FLAG] = 'Type (0 / 1)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.INC_EVENT_PHASE] = 'Decrement';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.COMBAT_STOP] = 'Spell id';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.REMOVEAURASFROMSPELL] = 'Charges';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.FOLLOW] = 'Angle';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.RANDOM_PHASE] = 'Phasemask 2';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.RANDOM_PHASE_RANGE] = 'Phasemask 2';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_INST_DATA] = 'Data';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_INST_DATA64] = 'Data';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.UPDATE_TEMPLATE] = 'Team';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CALL_FOR_HELP] = 'Say text (0/1)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_INVINCIBILITY_HP_LEVEL] = 'Pct value';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.MOUNT_TO_ENTRY_OR_MODEL] = 'Creature model';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_DATA] = 'Data';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SUMMON_GO] = 'Duration (ms)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.WP_START] = 'Waypoint entry';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.WP_STOP] = 'Quest id';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.ADD_ITEM] = 'Count';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.REMOVE_ITEM] = 'Count';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_COUNTER] = 'Decimal';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CREATE_TIMED_EVENT] = 'InitialMin';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.EQUIP] = 'Slotmask';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_RANGED_MOVEMENT] = 'Attack angle';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CALL_TIMED_ACTIONLIST] = 'Timer type (0/1/2)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.INVOKER_CAST] = 'Cast Flags';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CROSS_CAST] = 'Cast Flags';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CALL_RANDOM_TIMED_ACTIONLIST] = 'Script entry 2';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.CALL_RANDOM_RANGE_TIMED_ACTIONLIST] = 'Script entry 2';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_UNIT_FIELD_BYTES_1] = 'Type (0/2/3)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.REMOVE_UNIT_FIELD_BYTES_1] = 'Type (0/2/3)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.INTERRUPT_SPELL] = 'Spell id (0 any)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.JUMP_TO_POS] = 'Speed Z';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SEND_GOSSIP_MENU] = 'Npc text id';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SUMMON_CREATURE_GROUP] = 'Attack invoker (0 / 1)';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.SET_POWER] = 'Power value';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.ADD_POWER] = 'Power value';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.REMOVE_POWER] = 'Power value';
SAI_ACTION_PARAM2_TEXTS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Waypoint 2';
// TODO: add missing values

export const SAI_ACTION_PARAM3_TEXTS = [];
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.RANDOM_EMOTE] = 'Emote id 3';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.SUMMON_CREATURE] = 'Duration (milliseconds)';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.FOLLOW] = 'End creature entry';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.RANDOM_PHASE] = 'Phasemask 3';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.WP_START] = 'Repeat path (0/1)';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.WP_STOP] = 'Fail quest (0/1)';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.CREATE_TIMED_EVENT] = 'InitialMax';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.EQUIP] = 'Item entry 1';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.CROSS_CAST] = 'Target type of caster';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.CALL_RANDOM_TIMED_ACTIONLIST] = 'Script entry 3';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.INTERRUPT_SPELL] = 'Instant (0/1)';
SAI_ACTION_PARAM3_TEXTS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Waypoint 3';
// TODO: add missing values

export const SAI_ACTION_PARAM4_TEXTS = [];
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.RANDOM_EMOTE]  = 'Emote id 4';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.SUMMON_CREATURE] = 'Attack invoker (0/1)';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.FOLLOW] = 'Credit creature entry';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.RANDOM_PHASE] = 'Phasemask 4';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.WP_START] = 'Quest id';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.CREATE_TIMED_EVENT] = 'RepeatMin';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.EQUIP] = 'Item entry 2';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.CROSS_CAST] = 'Target parameter 1 of caster';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.CALL_RANDOM_TIMED_ACTIONLIST] = 'Script entry 4';
SAI_ACTION_PARAM4_TEXTS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Waypoint 4';
// TODO: add missing values

export const SAI_ACTION_PARAM5_TEXTS = [];
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.RANDOM_EMOTE] = 'Emote id 5';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.FOLLOW] = 'Credit type (0 / 1)';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.RANDOM_PHASE] = 'Phasemask 5';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.WP_START] = 'Despawn time after path';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.CREATE_TIMED_EVENT] = 'RepeatMax';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.EQUIP] = 'Item entry 3';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.CROSS_CAST] = 'Target parameter 2 of caster';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.CALL_RANDOM_TIMED_ACTIONLIST] = 'Script entry 5';
SAI_ACTION_PARAM5_TEXTS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Waypoint 5';
// TODO: add missing values

export const SAI_ACTION_PARAM6_TEXTS = [];
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.RANDOM_EMOTE] = 'Emote id 6';
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.RANDOM_PHASE] = 'Phasemask 6';
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.WP_START] = 'Reactstate';
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.CREATE_TIMED_EVENT] = 'Chance';
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.CROSS_CAST] = 'Target parameter 3 of caster';
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.CALL_RANDOM_TIMED_ACTIONLIST] = 'Script entry 6';
SAI_ACTION_PARAM6_TEXTS[SAI_ACTIONS.START_CLOSEST_WAYPOINT] = 'Waypoint 6';
// TODO: add missing values
