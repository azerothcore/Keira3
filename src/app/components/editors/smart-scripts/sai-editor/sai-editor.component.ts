...
import {
  SAI_EVENT_PARAM1_TEXTS,
  SAI_EVENT_PARAM1_TOOLTIPS, SAI_EVENT_PARAM2_TEXTS,
  SAI_EVENT_PARAM2_TOOLTIPS, SAI_EVENT_PARAM3_TEXTS,
  SAI_EVENT_PARAM3_TOOLTIPS, SAI_EVENT_PARAM4_TEXTS,
  SAI_EVENT_PARAM4_TOOLTIPS, SAI_EVENT_PARAM5_TEXTS,
  SAI_EVENT_PARAM5_TOOLTIPS, SAI_EVENT_TOOLTIPS, SAI_EVENTS, SAI_EVENTS_KEYS
} from './constants/sai-event';
import {
  SAI_ACTION_PARAM1_TEXTS,
  SAI_ACTION_PARAM1_TOOLTIPS, SAI_ACTION_PARAM2_TEXTS,
  SAI_ACTION_PARAM2_TOOLTIPS, SAI_ACTION_PARAM3_TEXTS,
  SAI_ACTION_PARAM3_TOOLTIPS, SAI_ACTION_PARAM4_TEXTS,
  SAI_ACTION_PARAM4_TOOLTIPS, SAI_ACTION_PARAM5_TEXTS,
  SAI_ACTION_PARAM5_TOOLTIPS, SAI_ACTION_PARAM6_TEXTS,
  SAI_ACTION_PARAM6_TOOLTIPS, SAI_ACTION_TOOLTIPS, SAI_ACTIONS, SAI_ACTIONS_KEYS
} from './constants/sai-actions';
import {
  SAI_TARGET_PARAM1_TEXTS,
  SAI_TARGET_PARAM1_TOOLTIPS, SAI_TARGET_PARAM2_TEXTS,
  SAI_TARGET_PARAM2_TOOLTIPS, SAI_TARGET_PARAM3_TEXTS,
  SAI_TARGET_PARAM3_TOOLTIPS,
  SAI_TARGET_PARAM4_TEXTS,
...
export class SaiEditorComponent extends MultiRowEditorComponent<SmartScripts> {
  ...
  public readonly EVENT_PARAM1_TEXTS = SAI_EVENT_PARAM1_TEXTS;
  public readonly EVENT_PARAM2_TEXTS = SAI_EVENT_PARAM2_TEXTS;
  public readonly EVENT_PARAM3_TEXTS = SAI_EVENT_PARAM3_TEXTS;
  public readonly EVENT_PARAM4_TEXTS = SAI_EVENT_PARAM4_TEXTS;
  public readonly EVENT_PARAM5_TEXTS = SAI_EVENT_PARAM5_TEXTS;
  public readonly ACTION_PARAM1_TEXTS = SAI_ACTION_PARAM1_TEXTS;
  public readonly ACTION_PARAM2_TEXTS = SAI_ACTION_PARAM2_TEXTS;
  public readonly ACTION_PARAM3_TEXTS = SAI_ACTION_PARAM3_TEXTS;
  public readonly ACTION_PARAM4_TEXTS = SAI_ACTION_PARAM4_TEXTS;
  public readonly ACTION_PARAM5_TEXTS = SAI_ACTION_PARAM5_TEXTS;
  public readonly ACTION_PARAM6_TEXTS = SAI_ACTION_PARAM6_TEXTS;
  public readonly TARGET_PARAM1_TEXTS = SAI_TARGET_PARAM1_TEXTS;
  public readonly TARGET_PARAM2_TEXTS = SAI_TARGET_PARAM2_TEXTS;
  public readonly TARGET_PARAM3_TEXTS = SAI_TARGET_PARAM3_TEXTS;
  public readonly TARGET_PARAM4_TEXTS = SAI_TARGET_PARAM4_TEXTS;
