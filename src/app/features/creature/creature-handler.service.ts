...
export class CreatureHandlerService extends HandlerService<CreatureTemplate> {
  ...
  get isNpcTrainerUnsaved(): boolean { return this.statusMap[NPC_TRAINER_TABLE]; }
  get isCreatureQuestitemUnsaved(): boolean { return this.statusMap[CREATURE_QUESTITEM_TABLE]; }
  get isCreatureLootTemplateUnsaved(): boolean { return this.statusMap[CREATURE_LOOT_TEMPLATE_TABLE]; }
  get isPickpocketingLootTemplateUnsaved(): boolean { return this.statusMap[PICKPOCKETING_LOOT_TEMPLATE_TABLE]; }
