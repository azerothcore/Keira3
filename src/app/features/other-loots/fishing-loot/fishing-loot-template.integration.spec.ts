...
describe('FishingLootTemplate integration tests', () => {
  ...
  describe('Creating new', () => {
    ...
    it('should correctly initialise', () => {
      ...
      expect(page.getInputById('Fishing').disabled).toBe(true);
    ...
    it('adding new rows and executing the query should correctly work', () => {
      ...
      const expectedQuery = 'DELETE FROM `fishing_loot_template` WHERE (`Entry` = 1234) AND (`Item` IN (0, 1, 2));\n' +
        'INSERT INTO `fishing_loot_template` (`Entry`, `Item`, `Fishing`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, ' +
    ...
    it('adding a row and changing its values should correctly update the queries', () => {
      ...
      page.expectDiffQueryToContain(
        ...
        'INSERT INTO `fishing_loot_template` (`Entry`, `Item`, `Fishing`, `Chance`, `QuestRequired`, `LootMode`, ' +
